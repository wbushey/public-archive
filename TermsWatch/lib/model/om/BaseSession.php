...
abstract class BaseSession extends BaseObject  implements Persistent {
  ...
  const PEER = 'SessionPeer';
	...
	public function setUid($v)
	{
		...
		if ($this->uid !== $v || $v === 0) {
			$this->uid = $v;
			$this->modifiedColumns[] = SessionPeer::UID;
		}
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(SessionPeer::UID))) {
				return false;
			}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SessionPeer::UID)) $criteria->add(SessionPeer::UID, $this->uid);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(SessionPeer::SID, $this->sid);
