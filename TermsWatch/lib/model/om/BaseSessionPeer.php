...
abstract class BaseSessionPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Sid', 'Uid', 'Timestamp', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('sid', 'uid', 'timestamp', ),
		BasePeer::TYPE_COLNAME => array (self::SID, self::UID, self::TIMESTAMP, ),
		BasePeer::TYPE_FIELDNAME => array ('sid', 'uid', 'timestamp', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Sid' => 0, 'Uid' => 1, 'Timestamp' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('sid' => 0, 'uid' => 1, 'timestamp' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::SID => 0, self::UID => 1, self::TIMESTAMP => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('sid' => 0, 'uid' => 1, 'timestamp' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(SessionPeer::UID);
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseSessionPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($criteria->containsKey(SessionPeer::SID) && $criteria->keyContainsValue(SessionPeer::SID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.SessionPeer::SID.')');
		}
    ...
    foreach (sfMixer::getCallables('BaseSessionPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(SessionPeer::SID);
			$selectCriteria->add(SessionPeer::SID, $criteria->remove(SessionPeer::SID), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(SessionPeer::SID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(SessionPeer::SID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(SessionPeer::DATABASE_NAME);
			$criteria->add(SessionPeer::SID, $pks, Criteria::IN);
