...
abstract class BaseUserPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Uid', 'Username', 'Password', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('uid', 'username', 'password', ),
		BasePeer::TYPE_COLNAME => array (self::UID, self::USERNAME, self::PASSWORD, ),
		BasePeer::TYPE_FIELDNAME => array ('uid', 'username', 'password', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Uid' => 0, 'Username' => 1, 'Password' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('uid' => 0, 'username' => 1, 'password' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::UID => 0, self::USERNAME => 1, self::PASSWORD => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('uid' => 0, 'username' => 1, 'password' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
    ...
    foreach (sfMixer::getCallables('BaseUserPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(UserPeer::UID, $criteria->remove(UserPeer::UID), $comparison);
