...
abstract class BaseCompanyPeer {
	...
	const IMAGE_SMALL = 'company.IMAGE_SMALL';

	/** the column name for the IMAGE_LARGE field */
	const IMAGE_LARGE = 'company.IMAGE_LARGE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Cid', 'Name', 'ImageSmall', 'ImageLarge', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('cid', 'name', 'imageSmall', 'imageLarge', ),
		BasePeer::TYPE_COLNAME => array (self::CID, self::NAME, self::IMAGE_SMALL, self::IMAGE_LARGE, ),
		BasePeer::TYPE_FIELDNAME => array ('cid', 'name', 'image_small', 'image_large', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Cid' => 0, 'Name' => 1, 'ImageSmall' => 2, 'ImageLarge' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('cid' => 0, 'name' => 1, 'imageSmall' => 2, 'imageLarge' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::CID => 0, self::NAME => 1, self::IMAGE_SMALL => 2, self::IMAGE_LARGE => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('cid' => 0, 'name' => 1, 'image_small' => 2, 'image_large' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CompanyPeer::CID);

		$criteria->addSelectColumn(CompanyPeer::NAME);

		$criteria->addSelectColumn(CompanyPeer::IMAGE_SMALL);

		$criteria->addSelectColumn(CompanyPeer::IMAGE_LARGE);
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseCompanyPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($criteria->containsKey(CompanyPeer::CID) && $criteria->keyContainsValue(CompanyPeer::CID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.CompanyPeer::CID.')');
		}
    ...
    foreach (sfMixer::getCallables('BaseCompanyPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(CompanyPeer::CID);
			$selectCriteria->add(CompanyPeer::CID, $criteria->remove(CompanyPeer::CID), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(CompanyPeer::CID, (array) $values, Criteria::IN);
		...
		try {
			...
			// invalidate objects in PolicyPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related Policy objects
			$c = new Criteria(PolicyPeer::DATABASE_NAME);
			
			$c->add(PolicyPeer::CID, $obj->getCid());
			$affectedRows += PolicyPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(CompanyPeer::CID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(CompanyPeer::DATABASE_NAME);
			$criteria->add(CompanyPeer::CID, $pks, Criteria::IN);
