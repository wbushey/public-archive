...
abstract class BaseLogPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Sid', 'Pid', 'Timestamp', 'Outcome', 'Message', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('sid', 'pid', 'timestamp', 'outcome', 'message', ),
		BasePeer::TYPE_COLNAME => array (self::SID, self::PID, self::TIMESTAMP, self::OUTCOME, self::MESSAGE, ),
		BasePeer::TYPE_FIELDNAME => array ('sid', 'pid', 'timestamp', 'outcome', 'message', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Sid' => 0, 'Pid' => 1, 'Timestamp' => 2, 'Outcome' => 3, 'Message' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('sid' => 0, 'pid' => 1, 'timestamp' => 2, 'outcome' => 3, 'message' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::SID => 0, self::PID => 1, self::TIMESTAMP => 2, self::OUTCOME => 3, self::MESSAGE => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('sid' => 0, 'pid' => 1, 'timestamp' => 2, 'outcome' => 3, 'message' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(LogPeer::SID);

		$criteria->addSelectColumn(LogPeer::PID);

		$criteria->addSelectColumn(LogPeer::TIMESTAMP);

		$criteria->addSelectColumn(LogPeer::OUTCOME);
	...
	public static function doCountJoinPolicy(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(LogPeer::PID,), array(PolicyPeer::PID,), $join_behavior);
	...
	/**
	 * Selects a collection of Log objects pre-filled with their Policy objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    foreach (sfMixer::getCallables('BaseLogPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseLogPeer', $c, $con);
		...
		$c->addJoin(array(LogPeer::PID,), array(PolicyPeer::PID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Log) to $obj2 (Policy)
				$obj2->addLog($obj1);
      ...
      call_user_func($callable, 'BaseLogPeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Log) to the collection in $obj2 (Policy)
				$obj2->addLog($obj1);
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseLogPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($criteria->containsKey(LogPeer::SID) && $criteria->keyContainsValue(LogPeer::SID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.LogPeer::SID.')');
		}
    ...
    foreach (sfMixer::getCallables('BaseLogPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(LogPeer::SID);
			$selectCriteria->add(LogPeer::SID, $criteria->remove(LogPeer::SID), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(LogPeer::SID, (array) $values, Criteria::IN);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(LogPeer::DATABASE_NAME);
			$criteria->add(LogPeer::SID, $pks, Criteria::IN);
