...
abstract class BaseLog extends BaseObject  implements Persistent {
  ...
  const PEER = 'LogPeer';
	...
	public function setSid($v)
	{
		...
		if ($this->sid !== $v) {
			$this->sid = $v;
			$this->modifiedColumns[] = LogPeer::SID;
		}
	...
	public function setPid($v)
	{
		...
		if ($this->pid !== $v) {
			$this->pid = $v;
			$this->modifiedColumns[] = LogPeer::PID;
		}
	...
	public function setTimestamp($v)
	{
		...
		if ( $this->timestamp !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = LogPeer::TIMESTAMP;
			}
	...
	public function setOutcome($v)
	{
		...
		if ($this->outcome !== $v) {
			$this->outcome = $v;
			$this->modifiedColumns[] = LogPeer::OUTCOME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->sid = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					...
					$this->setSid($pk);  //[IMV] update autoincrement primary key
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(LogPeer::SID)) $criteria->add(LogPeer::SID, $this->sid);
		if ($this->isColumnModified(LogPeer::PID)) $criteria->add(LogPeer::PID, $this->pid);
		if ($this->isColumnModified(LogPeer::TIMESTAMP)) $criteria->add(LogPeer::TIMESTAMP, $this->timestamp);
		if ($this->isColumnModified(LogPeer::OUTCOME)) $criteria->add(LogPeer::OUTCOME, $this->outcome);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(LogPeer::SID, $this->sid);
