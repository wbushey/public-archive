...
class CompanyMapBuilder implements MapBuilder {
	...
	public function doBuild()
	{
		...
		$tMap->addPrimaryKey('CID', 'Cid', 'INTEGER', true, null);

		$tMap->addColumn('NAME', 'Name', 'VARCHAR', false, 255);

		$tMap->addColumn('IMAGE_SMALL', 'ImageSmall', 'VARCHAR', false, 128);

		$tMap->addColumn('IMAGE_LARGE', 'ImageLarge', 'VARCHAR', false, 128);
