<?php
// $Id: DiffEngine.php,v 1.4 2008/01/30 18:34:13 weitzman Exp $
...
class DrupalDiffFormatter extends DiffFormatter
{
  ...
  function _block_header($xbeg, $xlen, $ybeg, $ylen) {
    return array(
      array(
        'data' => theme_diff_header_line($xbeg),
        'colspan' => 2
      ),
      array(
        'data' => theme_diff_header_line($ybeg),
        'colspan' => 2
      )
    );
  }
  ...
  function addedLine($line) {
    return array(
      '+',
      array(
        'data' => theme_diff_content_line($line),
...
function theme_diff_header_line($lineno) {
  return '<strong>Line '.$lineno.'</strong>';
}
