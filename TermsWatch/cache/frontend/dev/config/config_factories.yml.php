...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/home/bill/Development/workspace/TermsWatch/log/frontend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/home/bill/Development/workspace/TermsWatch/cache/frontend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/home/bill/Development/workspace/TermsWatch/apps/frontend/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_routing', 'sfPatternRouting');
      $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/bill/Development/workspace/TermsWatch/cache/frontend/dev/config/routing',
  'lifetime' => 31556926,
  'prefix' => '/home/bill/Development/workspace/TermsWatch/apps/frontend/routing',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/home/bill/Development/workspace/TermsWatch/cache/frontend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/home/bill/Development/workspace/TermsWatch/apps/frontend/template',
)));
