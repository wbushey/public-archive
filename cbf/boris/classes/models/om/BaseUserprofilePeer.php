...
/**
 * Base static class for performing query and update operations on the 'userProfile' table.
 *
...
abstract class BaseUserprofilePeer {
	...
	const CLASS_DEFAULT = 'models.Userprofile';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Username', 'Password', 'Usertype', 'Emailaddress', 'Ip', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'username', 'password', 'usertype', 'emailaddress', 'ip', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USERNAME, self::PASSWORD, self::USERTYPE, self::EMAILADDRESS, self::IP, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'USERNAME', 'PASSWORD', 'USERTYPE', 'EMAILADDRESS', 'IP', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'username', 'password', 'userType', 'emailAddress', 'ip', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Username' => 1, 'Password' => 2, 'Usertype' => 3, 'Emailaddress' => 4, 'Ip' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'username' => 1, 'password' => 2, 'usertype' => 3, 'emailaddress' => 4, 'ip' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USERNAME => 1, self::PASSWORD => 2, self::USERTYPE => 3, self::EMAILADDRESS => 4, self::IP => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'USERNAME' => 1, 'PASSWORD' => 2, 'USERTYPE' => 3, 'EMAILADDRESS' => 4, 'IP' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'username' => 1, 'password' => 2, 'userType' => 3, 'emailAddress' => 4, 'ip' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(UserprofilePeer::USERNAME);
			$criteria->addSelectColumn(UserprofilePeer::PASSWORD);
			$criteria->addSelectColumn(UserprofilePeer::USERTYPE);
			$criteria->addSelectColumn(UserprofilePeer::EMAILADDRESS);
			$criteria->addSelectColumn(UserprofilePeer::IP);
		} else {
	...
	/**
	 * Method to invalidate the instance pool of all tables related to userProfile
	...
	/**
	 * Deletes all rows from the userProfile table.
	 *
	 * @param      PropelPDO $con the connection to use
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			$c = clone $criteria;
			$affectedRows += UserprofilePeer::doOnDeleteCascade($c, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(PostsPeer::POSTERID, $obj->getId());
			...
			$criteria->add(TourneyUserActionPeer::USER_ID, $obj->getId());
	...
	public static function doValidate($obj, $cols = null)
	{
		...
		if ($obj->isNew() || $obj->isColumnModified(UserprofilePeer::EMAILADDRESS))
			$columns[UserprofilePeer::EMAILADDRESS] = $obj->getEmailaddress();

		if ($obj->isNew() || $obj->isColumnModified(UserprofilePeer::USERNAME))
			$columns[UserprofilePeer::USERNAME] = $obj->getUsername();
