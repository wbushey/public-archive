...
/**
 * Base static class for performing query and update operations on the 'ad' table.
 *
 * Ad codes
 *
...
abstract class BaseAdPeer {
	...
	const DATE_ADDED = 'ad.DATE_ADDED';

	/** the column name for the IMAGE_ID field */
	const IMAGE_ID = 'ad.IMAGE_ID';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Position', 'DateAdded', 'ImageId', 'Code', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'position', 'dateAdded', 'imageId', 'code', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::POSITION, self::DATE_ADDED, self::IMAGE_ID, self::CODE, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'POSITION', 'DATE_ADDED', 'IMAGE_ID', 'CODE', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'position', 'date_added', 'image_id', 'code', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Position' => 2, 'DateAdded' => 3, 'ImageId' => 4, 'Code' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'position' => 2, 'dateAdded' => 3, 'imageId' => 4, 'code' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::POSITION => 2, self::DATE_ADDED => 3, self::IMAGE_ID => 4, self::CODE => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'POSITION' => 2, 'DATE_ADDED' => 3, 'IMAGE_ID' => 4, 'CODE' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'position' => 2, 'date_added' => 3, 'image_id' => 4, 'code' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(AdPeer::POSITION);
			$criteria->addSelectColumn(AdPeer::DATE_ADDED);
			$criteria->addSelectColumn(AdPeer::IMAGE_ID);
			$criteria->addSelectColumn(AdPeer::CODE);
		} else {
	...
	{
		// Invalidate objects in AdSelectionListPeer instance pool,
	...
	public static function doCountJoinImage(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(AdPeer::IMAGE_ID, ImagePeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of Ad objects pre-filled with their Image objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Ad) to the collection in $obj2 (Image)
				$obj2->addAd($obj1);
	...
	{
		return $withPrefix ? AdPeer::CLASS_DEFAULT : AdPeer::OM_CLASS;
	}
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related AdSelectionList objects
			$criteria = new Criteria(AdSelectionListPeer::DATABASE_NAME);
			
			$criteria->add(AdSelectionListPeer::AD_ID, $obj->getId());
			$affectedRows += AdSelectionListPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
