...
abstract class BaseImagePeer {
	...
	const DATE_ADDED = 'image.DATE_ADDED';
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Datatype', 'Name', 'Size', 'DateAdded', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'datatype', 'name', 'size', 'dateAdded', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::DATATYPE, self::NAME, self::SIZE, self::DATE_ADDED, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'DATATYPE', 'NAME', 'SIZE', 'DATE_ADDED', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'datatype', 'name', 'size', 'date_added', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Datatype' => 1, 'Name' => 2, 'Size' => 3, 'DateAdded' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'datatype' => 1, 'name' => 2, 'size' => 3, 'dateAdded' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::DATATYPE => 1, self::NAME => 2, self::SIZE => 3, self::DATE_ADDED => 4, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'DATATYPE' => 1, 'NAME' => 2, 'SIZE' => 3, 'DATE_ADDED' => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'datatype' => 1, 'name' => 2, 'size' => 3, 'date_added' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(ImagePeer::DATATYPE);
			$criteria->addSelectColumn(ImagePeer::NAME);
			$criteria->addSelectColumn(ImagePeer::SIZE);
			$criteria->addSelectColumn(ImagePeer::DATE_ADDED);
		} else {
	...
	{
		// Invalidate objects in ImageDataPeer instance pool,
	...
	public static function doDeleteAll(PropelPDO $con = null)
	{
		...
		try {
			...
			ImagePeer::doOnDeleteSetNull(new Criteria(ImagePeer::DATABASE_NAME), $con);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// cloning the Criteria in case it's modified by doSelect() or doSelectStmt()
			$c = clone $criteria;
			ImagePeer::doOnDeleteSetNull($c, $con);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related ImageData objects
			$criteria = new Criteria(ImageDataPeer::DATABASE_NAME);
			
			$criteria->add(ImageDataPeer::IMAGE_ID, $obj->getId());
			$affectedRows += ImageDataPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
	...
	protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// set fkey col in related Ad rows to NULL
			$selectCriteria = new Criteria(ImagePeer::DATABASE_NAME);
			$updateValues = new Criteria(ImagePeer::DATABASE_NAME);
			$selectCriteria->add(AdPeer::IMAGE_ID, $obj->getId());
			$updateValues->add(AdPeer::IMAGE_ID, null);
